...
class Domains {
   ...
   * @return {Promise}
   */
  changeNameServers(accountId, domainId, attributes, options = {}) {
    // attributes are like:
    // name_servers[name_server_name_1]: ns3.dnsimple.com
    // name_servers[name_server_name_2]: ns3.dnsimple.com
    // name_servers[name_server_name_3]: ns3.dnsimple.com
    // name_servers[name_server_name_4]: ns3.dnsimple.com
    // name_servers[name_server_name_5]:
    // name_servers[name_server_name_6]:
    // commit: Change name servers
    return this._client.post(`/${accountId}/domains/${domainId}/name_servers`, attributes, options);
  }
}
